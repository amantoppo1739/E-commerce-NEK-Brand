    ...
    async function validateToken() {
      ...
      try {
        const response = await fetch(
          `/api/auth/password-reset/validate?token=${token}&email=${encodeURIComponent(email)}`
        );
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center px-4 py-12">
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-gray-900 mb-4">Invalid or expired link</h1>
